...
9. "Just incase there are any problems, make it so that they can access the website fully, and if they click any features they would need an account for, they will be met with the login/register screen. But if they want to continue looking at the website without making an account, they can hit the back button and go back to the other screens." — reworked auth from a hard app-wide gate to per-feature gating, specifically so reviewers wouldn't be blocked from seeing the app.
